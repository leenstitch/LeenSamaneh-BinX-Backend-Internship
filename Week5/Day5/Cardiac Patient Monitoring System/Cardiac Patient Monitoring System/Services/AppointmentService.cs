    ...
    public class AppointmentService : IAppointmentService
    {
            ...
            CreateAppointmentDto dto)
        {
            ...
            var appointment = new Appointment
            {
                ...
                // Status is automatically Scheduled
        ...
        // Admin: Get appointments for a specific patient
    ...
    FilterMyAppointmentsAsync(
     ...
     FilterAllAsync(
            ...
            UpdateAppointmentDto dto)
        {
            ...
            // Do not allow editing cancelled/completed
            // appointments
            ...
            UpdateAppointmentStatusDto dto)
        {
            ...
            appointment.Status = (Appointment.AppointmentStatus)dto.Status;
