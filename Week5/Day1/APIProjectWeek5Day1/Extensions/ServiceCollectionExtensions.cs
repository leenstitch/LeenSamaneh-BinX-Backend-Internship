...
using APIProject.Services1.ServicesForWeek4;
...
namespace APIProject.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
            ...
            this IServiceCollection services)
        {
            ...
            services.AddScoped<IAuthService, AuthService>(); //for week 4 day 1

            services.AddScoped<IRefreshTokenService, RefreshTokenService>(); //for week 4 day 2

            services.AddScoped<IJwtService, JwtService>(); // for week 4 day 2
