// This service handles patient profile management and health monitoring.
// It provides operations for profiles, health summaries, and health status.
...
namespace Cardiac_Patient_Monitoring_System.Services
{
    public class PatientService : IPatientService
    {
        ...
        // Returns the authenticated patient's health summary.
        ...
        // Returns the authenticated patient's current health status.
        ...
        // Builds a combined health summary using the patient's
        // latest vital signs, active medications, recent diagnoses,
        // and upcoming appointment.
        ...
        // Evaluates the patient's latest vital signs and determines
        // whether the patient is stable or needs attention.
