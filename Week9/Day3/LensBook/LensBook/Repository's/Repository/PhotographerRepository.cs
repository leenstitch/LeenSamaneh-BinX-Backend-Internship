...
namespace LensBook.Repositories
{
    public class PhotographerRepository : IPhotographerRepository
    {
        ...
        //get all customers bookings for a specific photographer with performance measurement
        public async Task<IEnumerable<Booking>> GetMyBookingsAsync(int photographerId)
        {
            ...
            Console.WriteLine(
                $"GetMyBookingsAsync - Rows: {bookings.Count}, " +
                $"Elapsed Time: {stopwatch.ElapsedMilliseconds} ms");

            return bookings;
        }

        //get all customers bookings for a specific photographer using projection
