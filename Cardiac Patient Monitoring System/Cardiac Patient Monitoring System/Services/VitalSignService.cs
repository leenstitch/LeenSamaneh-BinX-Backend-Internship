    ...
    CompareLatestTwoAsync(int userId)
        {
            ...
            var latest = vitalSigns[0];
            var previous = vitalSigns[1];
            ...
            return new VitalSignComparisonDto
            {
                Previous = new VitalSignValuesDto
                {
                    ...
                    SystolicPressure = previous.SystolicPressure,
                    DiastolicPressure = previous.DiastolicPressure,
                    OxygenSaturation = previous.OxygenSaturation,
                ...
                Latest = new VitalSignValuesDto
                {
                    ...
                    SystolicPressure = latest.SystolicPressure,
                    DiastolicPressure = latest.DiastolicPressure,
                ...
                {
                    HeartRate = CompareLowerIsBetter(
                        previous.HeartRate,
                        latest.HeartRate),

                    SystolicPressure = CompareLowerIsBetter(
                        previous.SystolicPressure,
                        latest.SystolicPressure),

                    DiastolicPressure = CompareLowerIsBetter(
                        previous.DiastolicPressure,
                        latest.DiastolicPressure),

                    OxygenSaturation = CompareHigherIsBetter(
