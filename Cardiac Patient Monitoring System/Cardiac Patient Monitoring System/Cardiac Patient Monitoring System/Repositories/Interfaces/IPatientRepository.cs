...
namespace Cardiac_Patient_Monitoring_System.Repositories.Interfaces
{
    public interface IPatientRepository
    {
        ...
        // Retrieves a patient with all related health data by Patient ID.
        Task<Patient?> GetWithHealthDataByIdAsync(int patientId);

        // Retrieves a patient with all related health data by User ID.
        Task<Patient?> GetWithHealthDataByUserIdAsync(int userId);
    }
}