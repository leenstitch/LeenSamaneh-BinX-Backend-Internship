// This service handles refresh token generation and token renewal.
// It validates stored refresh tokens, revokes used tokens,
...
namespace Cardiac_Patient_Monitoring_System.Services
{
    public class RefreshTokenService : IRefreshTokenService
    {
        ...
        // Validates the refresh token and generates a new access
        // token and refresh token when the stored token is valid.
            ...
            string refreshToken)
        {
            ...
            // Rejects refresh tokens that have already been revoked.
            ...
            // Revokes the old refresh token after successful use.
