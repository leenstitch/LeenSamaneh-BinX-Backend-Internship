// This controller handles diagnosis management for Patients and Admins.
// It provides endpoints for retrieving, filtering, creating, updating,
// and deleting patient diagnoses.
...
namespace Cardiac_Patient_Monitoring_System.Controllers
{
    ...
    public class DiagnosesController : ControllerBase
    {
        ...
        // Gets diagnoses belonging to the authenticated patient.
        [HttpGet("my")]
        ...
        // Gets diagnoses belonging to a specific patient.
        ...
        // Filters diagnoses based on the provided query parameters.
        [HttpGet("filter")]
         [Authorize(Roles = "Admin")]
        ...
        // Creates a new diagnosis for the patient linked to the authenticated user.
        [HttpPost]
        [Authorize(Roles = "Patient")]
