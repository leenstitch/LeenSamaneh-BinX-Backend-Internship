...
<img width="601" height="235" alt="image" src="https://github.com/user-attachments/assets/cb0f628f-9d6b-434b-bfd4-66bc88e3638f" />


### EF Core Query Logging

We added `.LogTo()` to the EF Core configuration to **log the SQL queries generated by Entity Framework Core** to the console.

This was added to help us **monitor database queries, count the number of queries executed by each endpoint, and detect potential N+1 query problems** during development.

.LogTo(
    Console.WriteLine,
    LogLevel.Information)

We also enabled `.EnableSensitiveDataLogging()` during development to see parameter values in the logs, making it easier to analyze and debug the generated queries.
...
After checking the actual SQL queries, we did **not find a genuine N+1 Problem** in the tested endpoin
